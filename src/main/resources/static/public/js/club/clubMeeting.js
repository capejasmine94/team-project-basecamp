...
document.addEventListener('DOMContentLoaded', function() {
 ...
 function getUpcomingMeetingList(selectedDate) {
     fetch(`/api/club/regularMeeting?meeting_date=${selectedDate}&club_id=${param}`, {
         method: 'GET'
     })
         ...
         .then(response => {
             ...
             for(const upcomingMeetingData of response.data.upcomingMeetingList){
                ...
                //  upcomingMeetingClub.innerText = upcomingMeetingData.clubDto.name;
                 ...
                 const upcomingMeetingMemberCount = newUpcomingMeetingWrapper.querySelector('.upcoming-member-count');
                     upcomingMeetingMemberCount.innerText = upcomingMeetingData.meetingMemberCount;

                 const upcomingMeetingDescription = newUpcomingMeetingWrapper.querySelector('.upcoming-meeting-description');
                 upcomingMeetingDescription.innerText = upcomingMeetingData.upcomingMeetingDto.description;

                 const upcomingMeetingFee = newUpcomingMeetingWrapper.querySelector('.upcoming-meeting-fee');
                 ...
                 const dDay = newUpcomingMeetingWrapper.querySelector('.d-day');
                 dDay.innerText = upcomingMeetingData.dDay;
